...
public class CurrencyConversionController {
    ...
    public CurrencyConversion conversion(@PathVariable String from,
        ...
        String response = restTemplate.getForObject(URL, String.class);     // transforms request into json/xml format


        ObjectMapper objectMapper = new ObjectMapper();  //transforms json/xml in an pojo
        ...
        CurrencyEntity entity = new CurrencyEntity();   //connecting properties
        entity.setTo(to);
        entity.setFrom(from);
        entity.setAMOUNT(AMOUNT);
        entity.setResult(conversionResult);
